...
@Repository("first.master.ActMstrRepositoryCustomImpl")
public class ActMstrRepositoryCustomImpl extends FirstMasterQuerydslRepositorySupport implements ActMstrRepositoryCustom {
    private JPAQueryFactory queryFactory;
    private QActEntity qActEntity;

    public ActMstrRepositoryCustomImpl(@Qualifier("firstMasterJpaQueryFactory") JPAQueryFactory queryFactory) {
