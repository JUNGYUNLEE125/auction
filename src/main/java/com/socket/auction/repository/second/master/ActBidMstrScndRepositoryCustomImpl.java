...
import com.socket.auction.config.db.SecondMasterQuerydslRepositorySupport;
...
@Repository("second.master.ActBidMstrScndRepositoryCustomImpl")
public class ActBidMstrScndRepositoryCustomImpl extends SecondMasterQuerydslRepositorySupport implements ActBidMstrScndRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QActBidEntity qActBidEntity;

    public ActBidMstrScndRepositoryCustomImpl(@Qualifier("secondMasterJpaQueryFactory") JPAQueryFactory queryFactory) {
