...
@Repository("third.slave.ActThrdRepositoryCustomImpl")
public class ActThrdRepositoryCustomImpl extends ThirdSlaveQuerydslRepositorySupport implements ActThrdRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QActEntity qActEntity;

    public ActThrdRepositoryCustomImpl(@Qualifier("thirdSlaveJpaQueryFactory") JPAQueryFactory queryFactory) {
