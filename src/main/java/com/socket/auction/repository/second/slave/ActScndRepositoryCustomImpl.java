...
@Repository("second.slave.ActScndRepositoryCustomImpl")
public class ActScndRepositoryCustomImpl extends SecondSlaveQuerydslRepositorySupport implements ActScndRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QActEntity qActEntity;

    public ActScndRepositoryCustomImpl(@Qualifier("secondSlaveJpaQueryFactory") JPAQueryFactory queryFactory) {
