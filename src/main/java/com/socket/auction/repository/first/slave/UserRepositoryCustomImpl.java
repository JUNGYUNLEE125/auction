...
@Repository("first.slave.UserRepositoryCustomImpl")
public class UserRepositoryCustomImpl extends FirstSlaveQuerydslRepositorySupport implements UserRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QUserEntity qUserEntity;
    private QMmbrEntity qMmbrEntity;
    private QUserInfmStatEntity qUserInfmStatEntity;

    public UserRepositoryCustomImpl(@Qualifier("firstSlaveJpaQueryFactory") JPAQueryFactory queryFactory) {
