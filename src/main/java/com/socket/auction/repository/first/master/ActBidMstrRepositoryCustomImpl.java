...
@Repository("first.master.ActBidMstrRepositoryCustomImpl")
public class ActBidMstrRepositoryCustomImpl extends FirstMasterQuerydslRepositorySupport implements ActBidMstrRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QActBidEntity qActBidEntity;

    public ActBidMstrRepositoryCustomImpl(@Qualifier("firstMasterJpaQueryFactory") JPAQueryFactory queryFactory) {
