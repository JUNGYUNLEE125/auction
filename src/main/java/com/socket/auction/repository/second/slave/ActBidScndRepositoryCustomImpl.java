...
@Repository("second.slave.ActBidScndRepositoryCustomImpl")
public class ActBidScndRepositoryCustomImpl extends SecondSlaveQuerydslRepositorySupport implements ActBidScndRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QActBidEntity qActBidEntity;

    public ActBidScndRepositoryCustomImpl(@Qualifier("secondSlaveJpaQueryFactory") JPAQueryFactory queryFactory) {
