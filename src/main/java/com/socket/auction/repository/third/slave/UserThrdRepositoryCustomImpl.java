...
@Repository("third.slave.UserThrdRepositoryCustomImpl")
public class UserThrdRepositoryCustomImpl extends ThirdSlaveQuerydslRepositorySupport implements UserThrdRepositoryCustom  {
    private JPAQueryFactory queryFactory;
    private QUserEntity qUserEntity;
    private QMmbrEntity qMmbrEntity;
    private QUserInfmStatEntity qUserInfmStatEntity;

    public UserThrdRepositoryCustomImpl(@Qualifier("thirdSlaveJpaQueryFactory") JPAQueryFactory queryFactory) {
